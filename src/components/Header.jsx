export default function Header() {
    return (
        <header>
            ...
            <p>The scatterplot below is an interactive form of the data visualization created from the original notebook exploring the data. The original notebook can be found <a href = "https://colab.research.google.com/drive/1GTdbPkYI2Dnu6MuWAgI0OFY3ufOpEH2P?usp=sharing" target = "_blank">here</a>. Curious about the technologies used for this dashboard? Go <a href ="https://github.com/moonsdust/exoplanets/tree/main" target = "_blank">here</a>.</p>
        </header>
    )
}